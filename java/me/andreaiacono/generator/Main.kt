...
////    val cover = Thumbnails.of(tmdbReader.getSmallSizePoster(movieInfo.posterPath!!)).forceSize(154, 231).asBufferedImage()
////    val background = Thumbnails.of(tmdbReader.getOriginalSizeImage(movieInfo.backdropPath!!)).forceSize(1920, 1080).asBufferedImage()
